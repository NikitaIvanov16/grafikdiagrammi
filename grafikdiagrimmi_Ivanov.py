...
def graf():
    ...
    if flag==True:
        ...
        text=f"нельзя построить график"
    vastus.configure(text=f"D={D}\n{t}\n{text}")
t=0
def veel():
    global t
...
y.pack(side=LEFT)
Rd=Radiobutton(aken,text="kit",font="Calibri 26", fg="green",command=kit)
Rd2=Radiobutton(aken,text="o4ki",font="Calibri 26", fg="green",command=glases)
Rd3=Radiobutton(aken,text="zontik",font="Calibri 26", fg="green")
Rd4=Radiobutton(aken,text="6a6o4ka",font="Calibri 26", fg="green")
Rd5=Radiobutton(aken,text="Ljagushka",font="Calibri 26", fg="green")
